    ...
    <div ref={containerRef} className="relative h-screen flex items-center justify-center overflow-hidden bg-brand-ivory/50">
      ...
      >
        <div className="relative inline-block px-8 py-10 sm:px-16 sm:py-16 bg-white/5 backdrop-blur-[4px] rounded-[3rem] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
          ...
          <h1 className="text-white text-4xl sm:text-7xl font-display tracking-widest drop-shadow-[0_10px_30px_rgba(0,0,0,1)] mb-4 leading-tight">
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-blue-100 block sm:inline-block">CHAMITHA</span>
            <span className="italic font-light text-brand-primary-light mx-4 sm:mx-6 drop-shadow-[0_0_15px_rgba(70,130,180,0.5)] block sm:inline-block my-2 sm:my-0">&</span>
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-blue-100 block sm:inline-block">SAMEERA</span>
          </h1>
          <motion.div 
